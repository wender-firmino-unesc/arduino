/*
*  Senhas
*  Código Arduino para simular um display que informa a senha informada no teclado numérico
*  O asterisco (*) no teclado, apaga as informações e o sustenido (#) envia a informação ao display
